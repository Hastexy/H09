            ...
            if command == "b":
                ...
                while True:
                    ...
                    try:
                        ...
                        print("some error")
                c.players = input("Enter all 4 players in the team: ")
                c.captain = input("Enter the captain´s name: ")
                ...
                for elem in result:
                    print(f"name: {elem.name}; players: {elem.players}; captain: {elem.captain};")
            else:
